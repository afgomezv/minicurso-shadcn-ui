    ...
    <>
      ...
      <div className="flex overflow-hidden bg-white pt-16 dark:bg-slate-900">
        <aside
          ...
          aria-label="Sidebar"
        >
          <div className="relative flex-1 flex flex-col min-h-0 border border-gray-200 bg-white pt-0  dark:bg-slate-900 dark:border-slate-700">
                ...
                <ul className="space-y-2 pb-2">
                  {links.map((link) => (
                    <li key={link.href}>
                      <Link
                        href={link.href}
                        className="text-base capitalize text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group dark:hover:bg-slate-700 dark:text-gray-200"
                      >
        ...
        >
          <main>
            <div className="pt-6 px-4">
              <div className="w-full min-h-[calc(100vh-230px)]">
                <div className="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8  dark:bg-slate-800">
                  {children}
                </div>
              </div>
            </div>
          ...
          <footer className="bg-white md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 mx-4 print:hidden  dark:bg-slate-800">
            <ul className="flex items-center flex-wrap mb-6 md:mb-0">
              <li>
                <a
                  href="#"
                  className="text-sm font-normal text-gray-500 hover:underline mr-4 md:mr-6 dark:text-slate-100"
                >
              ...
              <li>
                <a
                  href="#"
                  className="text-sm font-normal text-gray-500 hover:underline  dark:text-slate-100"
                >
                  Contact
                </a>
              </li>
            ...
            <div className="flex sm:justify-center space-x-6">
              <a
                href="#"
                className="text-gray-500 hover:text-gray-900  dark:text-slate-100 dark:hover:text-slate-500"
              >
                <svg
                  className="h-5 w-5"
                  fill="currentColor"
          ...
          <p className="text-center text-sm text-gray-500 my-10  dark:text-slate-100">
